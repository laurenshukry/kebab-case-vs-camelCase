...
#grouped stats by programming experience
grouped_stats = data.groupby(['Programming Level', 'IdentifierStyle']).agg({
    'Time Taken': ['mean', 'std'],
    'IsCorrect': 'mean'
})
print("\nGrouped stats by programming experience:")
...
#interaction Plot - Programming Level and Identifier Style
plt.figure(figsize=(10, 6))
sns.barplot(x='Programming Level', y='Time Taken', hue='IdentifierStyle', data=data)
plt.title("Interaction: Programming Level and Identifier Style")
